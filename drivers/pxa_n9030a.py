...
"""
Driver stub for Keysight PXA N9030A spectrum analyzer.
"""
...
class PXAN9030A:
    ...
    def acquire_trace(self):
        """Return a placeholder trace (we'll refine later)."""
        # In a real implementation, you'd trigger, wait, and query TRACE?
        return []
